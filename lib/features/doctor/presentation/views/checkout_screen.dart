          ...
          return ListView(
            ...
            children: [
              ...
              Wrap(
                spacing: 8,
                children: [
                  ChoiceChip(label: const Text('COD'), selected: _payment == 'COD', onSelected: (_) => setState(() => _payment = 'COD')),
                  ChoiceChip(label: const Text('Card'), selected: _payment == 'Card', onSelected: (_) => setState(() => _payment = 'Card')),
                  ChoiceChip(label: const Text('Mobile Wallet'), selected: _payment == 'Mobile Wallet', onSelected: (_) => setState(() => _payment = 'Mobile Wallet')),
                ],
              ),
              const SizedBox(height: 16),
                ...
                onPressed: _loading
                    ...
                    : () async {
                        ...
                        Navigator.of(context).pushReplacement(
                          MaterialPageRoute(
                            builder: (_) => OrderConfirmationScreen(orderId: orderId, total: total),
                          ),
                        );
                      },
                child: _loading
